const translations = {
    ...
    en: {
        ...
        tour1_title: "Templo Mayor & Syncretism",
        tour1_desc: "Learn to identify how the stones of Aztec temples built colonial palaces.",
        tour2_title: "Trades & Daily Life",
        tour2_desc: "From the typists in Santo Domingo to authentic gastronomy (corn and chili).",
        tour3_title: "Legends of the Inquisition",
        tour3_desc: "Walk the oldest streets in America and discover the popular myths of the historic center.",
        tour_btn: "Book Now",
    ...
    fr: {
        ...
        tours_title: "Mes Visites",
        tour1_title: "Templo Mayor & Syncrétisme",
        tour1_desc: "Apprenez à identifier comment les pierres des temples aztèques ont construit les palais coloniaux.",
        tour2_title: "Métiers & Vie Quotidienne",
        tour2_desc: "Des dactylographes de Santo Domingo à la gastronomie authentique (maïs et piment).",
        tour3_title: "Légendes de l'Inquisition",
        tour3_desc: "Parcourez les plus vieilles rues d'Amérique et découvrez les mythes populaires du centre historique.",
        tour_btn: "Réserver",
    ...
    de: {
        ...
        tour1_title: "Templo Mayor & Synkretismus",
        tour1_desc: "Lernen Sie zu erkennen, wie die Steine aztekischer Tempel koloniale Paläste bauten.",
        tour2_title: "Handwerk & Alltag",
        tour2_desc: "Von den Schreibkräften in Santo Domingo bis zur authentischen Gastronomie (Mais und Chili).",
        tour3_title: "Legenden der Inquisition",
        tour3_desc: "Gehen Sie durch die ältesten Straßen Amerikas und entdecken Sie die populären Mythen des historischen Zentrums.",
        tour_btn: "Buchen",
